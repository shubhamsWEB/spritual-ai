/**
 * Custom initialization script for the Bhagavad Gita RAG system
 * Uses the specialized GitaDocumentProcessor
 */
...
const initSystem = async () => {
  try {
    logger.info('Starting system initialization with GitaDocumentProcessor...');
    ...
    // Initialize Gita document processor
    ...
    try {
      await ragService.initialize(nodes); // Initialize without adding nodes again
